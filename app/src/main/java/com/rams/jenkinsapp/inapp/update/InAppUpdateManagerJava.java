            ...
            public void onSuccess(AppUpdateInfo appUpdateInfo) {
                ...
                if (startUpdate) {
                    ...
                    if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_AVAILABLE) {
                        ...
                        Log.e(LOG_TAG, "checkForAppUpdate(): Update available. Version Code: " + appUpdateInfo.availableVersionCode());
                    } else if (appUpdateInfo.updateAvailability() == UpdateAvailability.UPDATE_NOT_AVAILABLE) {
                        Log.e(LOG_TAG, "checkForAppUpdate(): No Update available. Code: " + appUpdateInfo.updateAvailability());
                    }
                }
                ...
                .addOnSuccessListener(new OnSuccessListener<AppUpdateInfo>() {
                    ...
                    public void onSuccess(AppUpdateInfo appUpdateInfo) {
                        ...
                        if (appUpdateInfo.installStatus() == InstallStatus.DOWNLOADED) {
                            popupSnackbarForUserConfirmation();
                            reportStatus();
                            Log.e(LOG_TAG, "checkNewAppVersionState(): resuming flexible update. Code: " + appUpdateInfo.updateAvailability());
                        }
                        ...
                        if (appUpdateInfo.updateAvailability() == UpdateAvailability.DEVELOPER_TRIGGERED_UPDATE_IN_PROGRESS) {
                            ...
                            Log.e(LOG_TAG, "checkNewAppVersionState(): resuming immediate update. Code: " + appUpdateInfo.updateAvailability());
